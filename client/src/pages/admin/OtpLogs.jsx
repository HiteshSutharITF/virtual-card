            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-slate-50/50 border-b border-slate-100">
                  ...
                  <th className="px-8 py-6 text-[11px] font-black text-slate-400 uppercase tracking-[0.2em]">Mobile</th>
                    ...
                    <tr key={log._id} className="hover:bg-slate-50/50 transition-colors group">
                      ...
                      <td className="px-8 py-6">
                        <div className="flex items-center space-x-2 text-slate-500">
                          <Phone size={14} />
                          <span className="text-xs font-bold tracking-wider">{log.mobile}</span>
                        </div>
                      </td>
                      <td className="px-8 py-6">
